...
final class constants$91 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.downcallHandle(
        "Discord_AdditionalContent_Count",
        constants$91.const$0
    );
    static final StructLayout const$2 = MemoryLayout.structLayout(
        RuntimeHelper.POINTER.withName("opaque")
    ).withName("Discord_MessageHandle");
    static final VarHandle const$3 = constants$91.const$2.varHandle(MemoryLayout.PathElement.groupElement("opaque"));
