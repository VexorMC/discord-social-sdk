...
final class constants$76 {
    ...
    ).withName("Discord_LinkedLobby");
    static final VarHandle const$4 = constants$76.const$3.varHandle(MemoryLayout.PathElement.groupElement("opaque"));
    static final MethodHandle const$5 = RuntimeHelper.downcallHandle(
        "Discord_LinkedLobby_Init",
        constants$0.const$0
    );
}
