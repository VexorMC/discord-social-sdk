...
final class RuntimeHelper {
    ...
    static {
        try {
            InputStream in = RuntimeHelper.class.getResourceAsStream("/discord.dll");

            if (in == null) {
                throw new IOException("Failed to find native library resource: /discord.dll");
            }

            File tempDll = File.createTempFile("discord", ".dll");
